...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."MIGR_FILTER" IS OBJECT (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."MIGR_FILTER_SET" IS TABLE OF MIGR_FILTER;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."MIGR_REPORT_DETAIL_ROW" AS OBJECT
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."MIGR_REPORT_DETAIL_TABLE" AS TABLE OF MIGR_REPORT_DETAIL_ROW;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."MIGR_REPORT_SUM_ROW" AS OBJECT
       (LABEL           VARCHAR2(50),
	    SCHEMA_SUM      NUMBER,
        TABLE_SUM       NUMBER,
		INDEX_SUM       NUMBER,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."MIGR_REPORT_SUM_TABLE" AS TABLE OF MIGR_REPORT_SUM_ROW;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."NAME_AND_COUNT_ARRAY" IS VARRAY(30) OF name_and_count_t;
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."NAME_AND_COUNT_T" IS OBJECT (
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."NAMELIST" IS TABLE OF VARCHAR2(40);
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE TYPE "ADMIN"."OBJECTIDLIST" IS TABLE OF INTEGER;
...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
--------------------------------------------------------
--  DDL for Table EMPLOYEES_WORKED_HOURS
--------------------------------------------------------

  CREATE TABLE "ADMIN"."EMPLOYEES_WORKED_HOURS" 
   (	"ID" NUMBER(19,0) GENERATED ALWAYS AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE , 
	"WORKED_DATE" TIMESTAMP (6), 
	"WORKED_HOURS" NUMBER(19,0), 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_CAPTURED_SQL" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME", "NATIVE_SQL", "LINECOUNT") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_CATALOG_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_CATALOGS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "DBURL", "CATALOG_ID", "CATALOG_NAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_COLUMN_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_COLUMNDT_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME", "DATATYPE", "ISIDENTITY") AS 
  SELECT 'MD_COLUMNS' objtype, c.COLUMN_NAME objname, c.Id objid,  'MD_TABLES' MainObjType,t.table_name MAINOBJNAME, t.id MAINOBJID, s.name SchemaName, s.id schemaid, cat.catalog_name catalogname,cat.id catalogid, conn.name connname,conn.id  connid,proj.project_name projectname ,proj.id projectid,
NVL(conn.type,'CAPTURED') CapturedOrConverted, 
CASE WHEN conn.type IS NULL THEN cat.catalog_name||'.' ELSE '' END || s.name||'.'||t.table_name ||'.'||c.COLUMN_NAME QualifiedName,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_CONNECTIONS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "CONNECTION_NAME", "HOST", "PORT", "USERNAME", "DBURL") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    MD_CONNECTIONS.ID CONNECTION_ID ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_CONSTRAINTS_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_INDEX_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_PARTITIONS_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_PROGRAMS_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_SCHEMA" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_SCHEMA_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_STORED_PROGRAMS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "STORED_PROGRAM_ID", "PROGRAMTYPE", "STORED_PROGRAM_NAME", "PACKAGE_ID_FK") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name ,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_TABLES" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "DBURL", "CATALOG_ID", "CATALOG_NAME", "SCHEMA_ID", "SCHEMA_NAME", "TABLE_ID", "TABLE_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_TABLES_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_TABLE_TRIGGERS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "DUMMY_FLAG", "SCHEMA_ID", "SCHEMA_NAME", "TABLE_ID", "TABLE_NAME", "TRIGGER_ID", "TRIGGER_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_TRIGGER_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_VIEW_DETAILS" ("OBJTYPE", "OBJNAME", "OBJID", "MAINOBJTYPE", "MAINOBJNAME", "MAINOBJID", "SCHEMANAME", "SCHEMAID", "CATALOGNAME", "CATALOGID", "CONNNAME", "CONNID", "PROJECTNAME", "PROJECTID", "CAPTUREDORCONVERTED", "QUALIFIEDNAME") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_VIEWS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "DUMMY_FLAG", "SCHEMA_ID", "SCHEMA_NAME", "VIEW_ID", "VIEW_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_ALL_VIEW_TRIGGERS" ("PROJECT_ID", "PROJECT_NAME", "CONNECTION_ID", "HOST", "PORT", "USERNAME", "CATALOG_ID", "CATALOG_NAME", "DUMMY_FLAG", "SCHEMA_ID", "SCHEMA_NAME", "VIEW_ID", "VIEW_NAME", "TRIGGER_ID", "TRIGGER_NAME") AS 
  SELECT md_projects.id project_id ,
    md_projects.project_name project_name,
    md_connections.id connection_id ,
    md_connections.host host ,
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_DERIVATIVES" ("ID", "SRC_ID", "SRC_TYPE", "DERIVED_ID", "DERIVED_TYPE", "DERIVED_CONNECTION_ID_FK", "TRANSFORMED", "ORIGINAL_IDENTIFIER", "NEW_IDENTIFIER", "DERIVED_OBJECT_NAMESPACE", "DERIVATIVE_REASON", "SECURITY_GROUP_ID", "CREATED_ON", "CREATED_BY", "LAST_UPDATED_ON", "LAST_UPDATED_BY", "ENABLED") AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE NONEDITIONABLE VIEW "ADMIN"."MGV_SCRATCH_DERIVATIVES" ("ID", "SRC_ID", "SRC_TYPE", "DERIVED_ID", "DERIVED_TYPE", "DERIVED_CONNECTION_ID_FK", "TRANSFORMED", "ORIGINAL_IDENTIFIER", "NEW_IDENTIFIER", "DERIVED_OBJECT_NAMESPACE", "DERIVATIVE_REASON", "SECURITY_GROUP_ID", "CREATED_ON", "CREATED_BY", "LAST_UPDATED_ON", "LAST_UPDATED_BY", "ENABLED") AS 
...
SET DEFINE OFF;
Insert into ADMIN.EMPLOYEES (ID,BIRTHDATE,LAST_NAME,NAME,GENDER_ID,JOBS_ID) values (1,to_timestamp('01/01/83 00:00:00.000000000','DD/MM/RR HH24:MI:SSXFF'),'Perez','Juan',1,1);
Insert into ADMIN.EMPLOYEES (ID,BIRTHDATE,LAST_NAME,NAME,GENDER_ID,JOBS_ID) values (2,to_timestamp('07/04/96 00:00:00.000000000','DD/MM/RR HH24:MI:SSXFF'),'Castro','Oscar',1,1);
REM INSERTING into ADMIN.EMPLOYEES_WORKED_HOURS
SET DEFINE OFF;
REM INSERTING into ADMIN.GENDERS
SET DEFINE OFF;
Insert into ADMIN.GENDERS (ID,NAME) values (1,'hombre');
Insert into ADMIN.GENDERS (ID,NAME) values (2,'mujer');
REM INSERTING into ADMIN.JOBS
SET DEFINE OFF;
Insert into ADMIN.JOBS (ID,NAME,SALARY) values (1,'gerente',50000);
Insert into ADMIN.JOBS (ID,NAME,SALARY) values (2,'consultor',30000);
Insert into ADMIN.JOBS (ID,NAME,SALARY) values (3,'devops',50000);
Insert into ADMIN.JOBS (ID,NAME,SALARY) values (4,'QA',35000);
Insert into ADMIN.JOBS (ID,NAME,SALARY) values (5,'developer',45000);
--------------------------------------------------------
--  DDL for Index SYS_C007431
--------------------------------------------------------

  CREATE UNIQUE INDEX "ADMIN"."SYS_C007431" ON "ADMIN"."EMPLOYEES" ("ID") 
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ADMIN"."SYS_C007449" ON "ADMIN"."EMPLOYEES_WORKED_HOURS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS" ;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ADMIN"."SYS_C007435" ON "ADMIN"."GENDERS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE UNIQUE INDEX "ADMIN"."SYS_C007437" ON "ADMIN"."JOBS" ("ID") 
  PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."MD_META" 
AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."MIGRATION" 
AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."MIGRATION_REPORT" AS 
--get status
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."MIGRATION_TRANSFORMER" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."SS2K5ALLPLATFORM" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."SYB12ALLPLATFORM" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE "ADMIN"."TDALLPLATFORM" AS 
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."MD_META" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."MIGRATION" AS
/**
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."MIGRATION_REPORT" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."MIGRATION_TRANSFORMER" AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."SS2K5ALLPLATFORM" 
AS
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."SYB12ALLPLATFORM" AS   
...
--------------------------------------------------------
  ...
  CREATE OR REPLACE NONEDITIONABLE PACKAGE BODY "ADMIN"."TDALLPLATFORM" AS   
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."EMPLOYEES" ADD PRIMARY KEY ("ID")
...
--------------------------------------------------------
--  Constraints for Table EMPLOYEES_WORKED_HOURS
--------------------------------------------------------

  ALTER TABLE "ADMIN"."EMPLOYEES_WORKED_HOURS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."EMPLOYEES_WORKED_HOURS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  TABLESPACE "USERS"  ENABLE;
--------------------------------------------------------
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."GENDERS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."GENDERS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."JOBS" MODIFY ("ID" NOT NULL ENABLE);
  ALTER TABLE "ADMIN"."JOBS" ADD PRIMARY KEY ("ID")
  USING INDEX PCTFREE 10 INITRANS 2 MAXTRANS 255 COMPUTE STATISTICS 
  STORAGE(INITIAL 65536 NEXT 1048576 MINEXTENTS 1 MAXEXTENTS 2147483645
  PCTINCREASE 0 FREELISTS 1 FREELIST GROUPS 1
  BUFFER_POOL DEFAULT FLASH_CACHE DEFAULT CELL_FLASH_CACHE DEFAULT)
...
--------------------------------------------------------
  ...
  ALTER TABLE "ADMIN"."EMPLOYEES" ADD CONSTRAINT "FK2ML2WDXFNGKQQUR3K4BGO0GDJ" FOREIGN KEY ("GENDER_ID")
	  REFERENCES "ADMIN"."GENDERS" ("ID") ENABLE;
  ALTER TABLE "ADMIN"."EMPLOYEES" ADD CONSTRAINT "FKQBU1TARU55DDKCJ6Y2MU1OKJ7" FOREIGN KEY ("JOBS_ID")
	  REFERENCES "ADMIN"."JOBS" ("ID") ENABLE;
--------------------------------------------------------
--  Ref Constraints for Table EMPLOYEES_WORKED_HOURS
--------------------------------------------------------

  ALTER TABLE "ADMIN"."EMPLOYEES_WORKED_HOURS" ADD CONSTRAINT "FK7W9SJGE9D9AK4O7YBYGL7BNEN" FOREIGN KEY ("EMPLOYEE_ID")
	  REFERENCES "ADMIN"."EMPLOYEES" ("ID") ENABLE;
